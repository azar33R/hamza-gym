...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center gap-1 rounded-lg bg-zinc-900 p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
